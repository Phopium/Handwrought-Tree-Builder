...
class TalentTile(ctk.CTkFrame):
    def __init__(self, master, text="", textbox_text="", command=None, width=btn_width, height=btn_height, fg_color=default_btn_clr, **kwargs):
...
class TalentTreeApp(ctk.CTk):
    ...
    def populate_tab(self, tab, tree):
        ...
        for talent in tree["talents"]:
            ...
            btn = TalentTile(frame.canvas, text=talent["name"], textbox_text=talent["description"], width=btn_width, height=btn_height, fg_color=default_btn_clr)
            btn.place(x=px, y=py)
